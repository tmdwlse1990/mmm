...
#define MAX_SKILL 3200 ///Maximum skill can be hold by Player, Homunculus, & Mercenary (skill list) AND skill_db limit
...
#define MAX_RUNEDECOMPOSITION 8
...
enum e_enchantgrade : uint16{
	...
	#define MAX_ENCHANTGRADE ENCHANTGRADE_Shark
#else
...
enum equip_pos : uint32 {
	...
	// Combined
	EQP_ALL_HEAD			= EQP_COSTUME_HEAD_TOP|EQP_COSTUME_HEAD_MID|EQP_COSTUME_HEAD_LOW,
	EQP_COS_HM			= EQP_COSTUME_HEAD_TOP|EQP_COSTUME_HEAD_MID,
	EQP_COS_HL			= EQP_COSTUME_HEAD_TOP|EQP_COSTUME_HEAD_LOW,
	EQP_COS_ML			= EQP_COSTUME_HEAD_MID|EQP_COSTUME_HEAD_LOW,
