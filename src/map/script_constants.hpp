...
/// Do not modify code above this, since it will be automatically generated by the API again
	...
	export_constant(EFST_SKILL_UP1);
	export_constant(EFST_SKILL_UP2);
	export_constant(EFST_MEMBER1);
	export_constant(EFST_MEMBER2);
	export_constant(EFST_MEMBER3);
	export_constant(EFST_MEMBER4);
	export_constant(EFST_MEMBER5);
	export_constant(EFST_MEMBER6);
	export_constant(EFST_MEMBER7);
	export_constant(EFST_MEMBER8);
	export_constant(EFST_MEMBER9);
	export_constant(EFST_MEMBER10);
	...
	export_constant(ET_EMOTION_LAST);
	...
	export_constant(ENCHANTGRADE_Meow);
	export_constant(ENCHANTGRADE_Shark);
	...
	export_constant(SC_SKILL_UP1);
	export_constant(SC_SKILL_UP2);
	export_constant(SC_MEMBER1);
	export_constant(SC_MEMBER2);
	export_constant(SC_MEMBER3);
	export_constant(SC_MEMBER4);
	export_constant(SC_MEMBER5);
	export_constant(SC_MEMBER6);
	export_constant(SC_MEMBER7);
	...
	export_constant(GET_INFO_MONK_COMBO);
	...
	export_constant(SKILLRATE_TYPE_WEAPON);
	export_constant(SKILLRATE_TYPE_MAGIC);
	export_constant(SKILLRATE_TYPE_MISC);
	export_constant(SKILLRATE_TYPE_ALL);
