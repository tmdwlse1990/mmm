...
//Trans 2-2 Jobs
	...
	MAPID_CREATOR,
	MAPID_STALKER,
	MAPID_REBELLION = JOBL_UPPER |MAPID_GUNSLINGER,
	MAPID_KAGEROUOBORO,
...
enum _sp {
	...
	SP_HIT_PHYSICAL_DAMAGE_RATE
	
	,SP_HIT_MAGICAL_DAMAGE_RATE,SP_CRIT_MATK_DMG,SP_CRIT_ATK_DMG, SP_CRIT_DMG_RATE
	,SP_ALL_STATS_RATE,SP_ALL_TRAIT_STATS_RATE
	,SP_STRRATE,SP_AGIRATE,SP_VITRATE,SP_INTRATE,SP_DEXRATE,SP_LUKRATE
	,SP_POWRATE,SP_STARATE,SP_WISRATE,SP_SPLRATE,SP_CONRATE,SP_CRTRATE
	,SP_SKILL_AOE, SP_UPSKILL1,SP_UPSKILL2,SP_UPSKILL3,SP_UPSKILL4,SP_UPSKILL5,SP_UPSKILL6,SP_UPSKILL7,SP_UPSKILL8
	,SP_NO_FATAL, SP_ASPD_CAP, SP_DROP_UP
	,SP_IGNORE_DEF_POINTS,SP_IGNORE_MDEF_POINTS, SP_NORMAL_RATIO
	,SP_SKILLRATE, SP_SKILLRATE_DEF, SP_COOLDOWNRATE, SP_HP_DRAIN_PER, SP_SP_DRAIN_PER
};
